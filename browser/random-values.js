...
function randomArray(array, numOfElementsToTake) {
  var random1 = random(1, array.length);
  var arrayOfNumbers = [];
  var i;
  var list;

  numOfElementsToTake = numOfElementsToTake || random1;
...
}).call(this,require("1YiZ5S"),typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {},require("buffer").Buffer,arguments[3],arguments[4],arguments[5],arguments[6],"/fake_3f27052.js","/")
